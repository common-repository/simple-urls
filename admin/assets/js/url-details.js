jQuery(document).ready(function() {
	...
	function first_link_notification() {
		...
		if ( is_first_link === 'true' && license_status !== '1' ) {
			lasso_lite_helper.do_notification(`Congrats on your first link! <a href="https://app.getlasso.co/checkout/startup" target="_blank" class="white underline"><strong> Upgrade </strong></a>to protect it with link monitoring and Lasso's stable product data API.`, 'green', "default-template-notification", false);
		}
	}
	...
	function no_api_key_notification() {
		...
		if ( ! amazon_access_key_id ) {
			lasso_lite_helper.do_notification(`No API key detected for images and pricing! <a href="https://app.getlasso.co/checkout/startup" target="_blank" class="white underline"><strong> Upgrade to Access Lasso's Amazon product data API </strong></a>`, 'orange', "default-template-notification", false);
		}
	}	
});
