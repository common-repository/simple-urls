var lasso_lite_helper = {
	 ...
	 * @param is_overwrite
	 */
	inject_to_template( el_container, jsrender_template_id, data, is_overwrite = true ) {
	...
	do_notification(message = '', color = 'green', template_id = "default-template-notification", is_overwrite = true) {
		...
		lasso_lite_helper.inject_to_template(jQuery("#lasso_lite_notifications"), template_id, json_data, is_overwrite);
